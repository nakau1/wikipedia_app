/*
	...
	let searchHistory = SearchHistoryViewController.create()
	searchHistory.delegate = self
	let reservationHistory = ReservationHistoryViewController.create()
	reservationHistory.delegate = self
	let favoriteParkingList = FavoriteParkingListViewController.create()
	favoriteParkingList.delegate = self
	
	
	navigationController.viewControllerArray = [searchHistory,reservationHistory,favoriteParkingList]
	addChildViewController(navigationController)
	
	let textSearchBaseViewPosition = textSearchBaseView.frame.origin.y + textSearchBaseView.frame.height
	navigationController.view.frame = CGRectMake(view.frame.origin.x,
		view.frame.origin.y + textSearchBaseViewPosition,
		view.frame.width,
		view.frame.height - textSearchBaseViewPosition)
